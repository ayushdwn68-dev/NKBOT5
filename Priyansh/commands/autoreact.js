...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
  ...
  if(react.includes("Soul") || react.includes("soul")) {
    ...
    if(react.includes("gn") || react.includes("GN") || react.includes("NIGHT") || react.includes("night") || react.includes("good night") || react.includes("GOOD NIGHT") || react.includes("NYT") || react.includes("nyt") || react.includes("so jao") || react.includes("me sone  ja rhi ") || react.includes("me sone ja rha ") || react.includes("") || react.includes("") || react.includes("Sasaktan") || react.includes("sasaktan") || react.includes("sad") || react.includes("Sad") || react.includes("malungkot") || react.includes("Malungkot") || react.includes(" 😥") || react.includes("😰") || react.includes("😨") || react.includes("😢") || react.includes(":(") || react.includes("😔") || react.includes("😞") || react.includes("depress") || react.includes("stress") || react.includes("Stress") || react.includes("Depress") || react.includes("depression") || react.includes("Depression") || react.includes("kalungkutan") || react.includes("Kalungkutan") || react.includes("😭")) {
      var sad = {
        body: "╔══════════════════╗\n\n 🌙❖ 𝑮𝑶𝑶𝑫 𝑵𝑰𝑮𝑯𝑻 ❖🌙  \n\n╚══════════════════╝\n\n✨ रात की चाँदनी संग ✨  \n\n ✦🌎 𝑵𝑲➺𝑩𝑶𝑻 🌎🦋🎀  \n\nकी तरफ़ से आप सभी को  \n\n🌸💤 शुभ रात्रि 💫🌙  \n\n━━━━━━━━━━━━━━━━━━━━━━━\n\n🌌 Stars Will Guard Your Sleep ✨  \n\n💭 Sweet Dreams & Positivity ❤️  \n\n😴 Rest Well, Tomorrow is Bright 🌅  \n\n━━━━━━━━━━━━━━━━━━━━━━━\n\n🔱🙏 भगवान के नाम 🙏🔱  \n\n🌺 जय श्री राम 🌺  \n\n🌸 राधे राधे 🌸  \n\n🕉️ हर हर महादेव 🕉️  \n\n━━━━━━━━━━━━━━━━━━━━━━━\n\n👑 𝑩𝑶𝑻 𝑶𝑾𝑵𝑬𝑹 👑 \n\n╔═════ ▓▓ ࿇💙࿇ ▓▓ ═════╗  \n\n 💜꧁ 𝑵𝑲≛𝑬𝑫𝑰𝑻𝑶𝑹 ꧂💙  \n\n╚═════ ▓▓ ࿇❤️࿇ ▓▓ ═════╝"
      }
