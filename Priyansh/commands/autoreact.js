...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
  ...
  if(react.includes("Soul") || react.includes("soul")) {
    ...
    if(react.includes("gn") || react.includes("GN") || react.includes("NIGHT") || react.includes("night") || react.includes("good night") || react.includes("GOOD NIGHT") || react.includes("NYT") || react.includes("nyt") || react.includes("so jao") || react.includes("me sone  ja rhi ") || react.includes("me sone ja rha ")) {
      var sad = {
